<template lang="html">
  <div class="home-carousel">
    <carousel :perPage="1" :autoplay="true" :autoplayHoverPause="true" :autoplayTimeout="7000" paginationActiveColor="#CF9405" class="container px-0">
      <!-- Intro -->
      <slide v-for="carousel in carousels" :key="carousel.title_en" class="col-12">
        <div class="row my-carousel">
          <!-- Images -->
          <div class="col-12 col-sm-5 col-md-6 widget--carousel-image">
          ...
          <div class="col-12 col-sm-7 col-md-6 widget--home-office widget--home-overview">
...
export default {
  ...
  data: () => ({
    ...
    //     subtitle_en: 'The African International law firm that safely takes you into Africa.',
