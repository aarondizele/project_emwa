            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-md-8 pl-md-3">
                <h4 class="widget--title mt-2">
                  <a :href="publication.link" class="widget--hover-brand-color" target="_blank" v-if="french || !publication.title_en">{{publication.title_fr}}</a>
                  <a :href="publication.link_en" class="widget--hover-brand-color" target="_blank" v-if="english || !publication.title_fr">{{publication.title_en}}</a>
                </h4>
